...
const std::string include_ip = "#include <linux/ip.h>" + nl;
...
// define constants
const std::string constant = "#define IPPROTO_ICMP 0x01" + nl +
                             "#define IPPROTO_TCP 0x06" + nl +
                             "#define IPPROTO_UDP 0x11" + nl +
                             "#define XDP_ACTION_MAX 5" + nl;
