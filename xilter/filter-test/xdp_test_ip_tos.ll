; ModuleID = 'xdp_test_ip_tos.c'
source_filename = "xdp_test_ip_tos.c"
...
define dso_local i32 @xdp_parse_prog(%struct.xdp_md* nocapture readonly %0) #0 section "xdp_generated" !dbg !85 {
  ...
  br i1 %14, label %78, label %15, !dbg !217
...
19:                                               ; preds = %15
  ...
  br i1 %23, label %78, label %24, !dbg !229
...
42:                                               ; preds = %37, %24, %32, %27
  ...
  %43 = getelementptr i8, i8* %7, i64 15, !dbg !255
  %44 = load i8, i8* %43, align 1, !dbg !255, !tbaa !257
  %45 = lshr i8 %44, 1, !dbg !258
  %46 = shl i8 %44, 7, !dbg !258
  %47 = or i8 %45, %46, !dbg !258
...
53:                                               ; preds = %42, %52, %51, %50, %49, %37, %32, %27, %15, %48
  %54 = phi i32 [ 0, %15 ], [ 1, %42 ], [ 6, %48 ], [ 0, %27 ], [ 0, %32 ], [ 0, %37 ], [ 2, %49 ], [ 3, %50 ], [ 4, %51 ], [ 5, %52 ], !dbg !200
  %55 = phi i32 [ 2, %15 ], [ 2, %42 ], [ 2, %48 ], [ 0, %27 ], [ 0, %32 ], [ 0, %37 ], [ 2, %49 ], [ 2, %50 ], [ 2, %51 ], [ 2, %52 ], !dbg !200
  ...
  call void @llvm.dbg.label(metadata !199), !dbg !261
  %56 = getelementptr inbounds [14 x i8], [14 x i8]* %3, i64 0, i64 0, !dbg !260
  call void @llvm.lifetime.start.p0i8(i64 14, i8* nonnull %56) #3, !dbg !260
  call void @llvm.dbg.declare(metadata [14 x i8]* %3, metadata !194, metadata !DIExpression()), !dbg !260
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 1 dereferenceable(14) %56, i8* nonnull align 1 dereferenceable(14) getelementptr inbounds ([14 x i8], [14 x i8]* @__const.xdp_parse_prog.____fmt, i64 0, i64 0), i64 14, i1 false), !dbg !260
  %57 = call i32 (i8*, i32, ...) inttoptr (i64 6 to i32 (i8*, i32, ...)*)(i8* nonnull %56, i32 14, i32 %54) #3, !dbg !260
  call void @llvm.lifetime.end.p0i8(i64 14, i8* nonnull %56) #3, !dbg !262
  %58 = bitcast i32* %2 to i8*, !dbg !263
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %58), !dbg !263
  call void @llvm.dbg.value(metadata %struct.xdp_md* %0, metadata !268, metadata !DIExpression()) #3, !dbg !263
  call void @llvm.dbg.value(metadata i32 %55, metadata !269, metadata !DIExpression()) #3, !dbg !263
  call void @llvm.dbg.value(metadata i32 %54, metadata !270, metadata !DIExpression()) #3, !dbg !263
  store i32 %54, i32* %2, align 4, !tbaa !283
  %59 = load i32, i32* %8, align 4, !dbg !284, !tbaa !210
  %60 = zext i32 %59 to i64, !dbg !285
  call void @llvm.dbg.value(metadata i64 %60, metadata !271, metadata !DIExpression()) #3, !dbg !263
  %61 = load i32, i32* %4, align 4, !dbg !286, !tbaa !202
  %62 = zext i32 %61 to i64, !dbg !287
  call void @llvm.dbg.value(metadata i64 %62, metadata !272, metadata !DIExpression()) #3, !dbg !263
  %63 = icmp ugt i32 %54, 5, !dbg !288
  br i1 %63, label %76, label %64, !dbg !290

64:                                               ; preds = %53
  call void @llvm.dbg.value(metadata i32* %2, metadata !270, metadata !DIExpression(DW_OP_deref)) #3, !dbg !263
  %65 = call i8* inttoptr (i64 1 to i8* (i8*, i8*)*)(i8* bitcast (%struct.bpf_map_def* @xdp_stats_map to i8*), i8* nonnull %58) #3, !dbg !291
  call void @llvm.dbg.value(metadata i8* %65, metadata !273, metadata !DIExpression()) #3, !dbg !263
  %66 = icmp eq i8* %65, null, !dbg !292
  br i1 %66, label %76, label %67, !dbg !294

67:                                               ; preds = %64
  call void @llvm.dbg.value(metadata i8* %65, metadata !273, metadata !DIExpression()) #3, !dbg !263
  %68 = sub nsw i64 %60, %62, !dbg !295
  call void @llvm.dbg.value(metadata i64 %68, metadata !281, metadata !DIExpression()) #3, !dbg !263
  %69 = bitcast i8* %65 to i64*, !dbg !296
  %70 = load i64, i64* %69, align 8, !dbg !297, !tbaa !298
  %71 = add i64 %70, 1, !dbg !297
  store i64 %71, i64* %69, align 8, !dbg !297, !tbaa !298
  %72 = getelementptr inbounds i8, i8* %65, i64 8, !dbg !301
  %73 = bitcast i8* %72 to i64*, !dbg !301
  %74 = load i64, i64* %73, align 8, !dbg !302, !tbaa !303
  %75 = add i64 %68, %74, !dbg !302
  store i64 %75, i64* %73, align 8, !dbg !302, !tbaa !303
  br label %76

76:                                               ; preds = %53, %64, %67
  %77 = phi i32 [ %55, %67 ], [ 0, %53 ], [ 0, %64 ], !dbg !263
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %58), !dbg !304
  br label %78, !dbg !305

78:                                               ; preds = %19, %1, %76
  %79 = phi i32 [ %77, %76 ], [ -1, %1 ], [ -1, %19 ], !dbg !200
  ret i32 %79, !dbg !306
}
...
!3 = !DIFile(filename: "xdp_test_ip_tos.c", directory: "/home/aino/Projects/xapture/filter/filter-test")
!4 = !{!5, !14}
...
!259 = !DILocation(line: 145, column: 2, scope: !85)
!260 = !DILocation(line: 147, column: 2, scope: !195)
!261 = !DILocation(line: 146, column: 1, scope: !85)
!262 = !DILocation(line: 147, column: 2, scope: !85)
!263 = !DILocation(line: 0, scope: !264, inlinedAt: !282)
!264 = distinct !DISubprogram(name: "xdp_stats_func", scope: !3, file: !3, line: 32, type: !265, scopeLine: 32, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !267)
!265 = !DISubroutineType(types: !266)
!266 = !{!65, !88, !65, !65}
!267 = !{!268, !269, !270, !271, !272, !273, !281}
!268 = !DILocalVariable(name: "ctx", arg: 1, scope: !264, file: !3, line: 32, type: !88)
!269 = !DILocalVariable(name: "action", arg: 2, scope: !264, file: !3, line: 32, type: !65)
!270 = !DILocalVariable(name: "priority", arg: 3, scope: !264, file: !3, line: 32, type: !65)
!271 = !DILocalVariable(name: "data_end", scope: !264, file: !3, line: 33, type: !44)
!272 = !DILocalVariable(name: "data", scope: !264, file: !3, line: 34, type: !44)
!273 = !DILocalVariable(name: "rec", scope: !264, file: !3, line: 35, type: !274)
!274 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !275, size: 64)
!275 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "datarec", file: !3, line: 16, size: 128, elements: !276)
!276 = !{!277, !280}
!277 = !DIDerivedType(tag: DW_TAG_member, name: "rx_packets", scope: !275, file: !3, line: 17, baseType: !278, size: 64)
!278 = !DIDerivedType(tag: DW_TAG_typedef, name: "__u64", file: !47, line: 31, baseType: !279)
!279 = !DIBasicType(name: "long long unsigned int", size: 64, encoding: DW_ATE_unsigned)
!280 = !DIDerivedType(tag: DW_TAG_member, name: "rx_bytes", scope: !275, file: !3, line: 18, baseType: !278, size: 64, offset: 64)
!281 = !DILocalVariable(name: "bytes", scope: !264, file: !3, line: 52, type: !278)
!282 = distinct !DILocation(line: 148, column: 9, scope: !85)
!283 = !{!204, !204, i64 0}
!284 = !DILocation(line: 33, column: 37, scope: !264, inlinedAt: !282)
!285 = !DILocation(line: 33, column: 26, scope: !264, inlinedAt: !282)
!286 = !DILocation(line: 34, column: 33, scope: !264, inlinedAt: !282)
!287 = !DILocation(line: 34, column: 22, scope: !264, inlinedAt: !282)
!288 = !DILocation(line: 41, column: 15, scope: !289, inlinedAt: !282)
!289 = distinct !DILexicalBlock(scope: !264, file: !3, line: 41, column: 6)
!290 = !DILocation(line: 37, column: 6, scope: !264, inlinedAt: !282)
!291 = !DILocation(line: 46, column: 8, scope: !264, inlinedAt: !282)
!292 = !DILocation(line: 47, column: 7, scope: !293, inlinedAt: !282)
!293 = distinct !DILexicalBlock(scope: !264, file: !3, line: 47, column: 6)
!294 = !DILocation(line: 47, column: 6, scope: !264, inlinedAt: !282)
!295 = !DILocation(line: 52, column: 25, scope: !264, inlinedAt: !282)
!296 = !DILocation(line: 53, column: 7, scope: !264, inlinedAt: !282)
!297 = !DILocation(line: 53, column: 17, scope: !264, inlinedAt: !282)
!298 = !{!299, !300, i64 0}
!299 = !{!"datarec", !300, i64 0, !300, i64 8}
!300 = !{!"long long", !205, i64 0}
!301 = !DILocation(line: 54, column: 7, scope: !264, inlinedAt: !282)
!302 = !DILocation(line: 54, column: 16, scope: !264, inlinedAt: !282)
!303 = !{!299, !300, i64 8}
!304 = !DILocation(line: 57, column: 1, scope: !264, inlinedAt: !282)
!305 = !DILocation(line: 148, column: 2, scope: !85)
!306 = !DILocation(line: 149, column: 1, scope: !85)
