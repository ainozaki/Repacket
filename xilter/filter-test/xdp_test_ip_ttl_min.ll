; ModuleID = 'xdp_test_ip_ttl_min.c'
source_filename = "xdp_test_ip_ttl_min.c"
...
define dso_local i32 @xdp_parse_prog(%struct.xdp_md* nocapture readonly %0) #0 section "xdp_generated" !dbg !85 {
  ...
  br i1 %14, label %80, label %15, !dbg !217
...
15:                                               ; preds = %1
  ...
  br i1 %18, label %19, label %55, !dbg !224
...
19:                                               ; preds = %15
  ...
  br i1 %23, label %80, label %24, !dbg !229
...
27:                                               ; preds = %24
  ...
  br i1 %31, label %55, label %42, !dbg !240
...
32:                                               ; preds = %24
  ...
  br i1 %36, label %55, label %42, !dbg !247
...
37:                                               ; preds = %24
  ...
  br i1 %41, label %55, label %42, !dbg !254

42:                                               ; preds = %37, %24, %32, %27
  call void @llvm.dbg.value(metadata i32 1, metadata !101, metadata !DIExpression()), !dbg !200
  %43 = getelementptr i8, i8* %7, i64 22, !dbg !255
  %44 = load i8, i8* %43, align 4, !dbg !255, !tbaa !257
  %45 = icmp eq i8 %44, -1, !dbg !258
  br i1 %45, label %55, label %46, !dbg !259

46:                                               ; preds = %42
  call void @llvm.dbg.value(metadata i32 2, metadata !101, metadata !DIExpression()), !dbg !200
  %47 = icmp ugt i8 %44, 63, !dbg !260
  br i1 %47, label %55, label %48, !dbg !262

48:                                               ; preds = %46
  call void @llvm.dbg.value(metadata i32 3, metadata !101, metadata !DIExpression()), !dbg !200
  %49 = icmp ugt i8 %44, 31, !dbg !263
  br i1 %49, label %55, label %50, !dbg !265

50:                                               ; preds = %48
  call void @llvm.dbg.value(metadata i32 4, metadata !101, metadata !DIExpression()), !dbg !200
  %51 = icmp ugt i8 %44, 15, !dbg !266
  br i1 %51, label %55, label %52, !dbg !268

52:                                               ; preds = %50
  call void @llvm.dbg.value(metadata i32 5, metadata !101, metadata !DIExpression()), !dbg !200
  %53 = icmp eq i8 %44, 0, !dbg !269
  %54 = select i1 %53, i32 6, i32 5
  br label %55

55:                                               ; preds = %52, %37, %32, %27, %15, %50, %48, %46, %42
  %56 = phi i32 [ 0, %15 ], [ 1, %42 ], [ 2, %46 ], [ 3, %48 ], [ 4, %50 ], [ 0, %27 ], [ 0, %32 ], [ 0, %37 ], [ %54, %52 ], !dbg !200
  %57 = phi i32 [ 2, %15 ], [ 2, %42 ], [ 2, %46 ], [ 2, %48 ], [ 2, %50 ], [ 0, %27 ], [ 0, %32 ], [ 0, %37 ], [ 2, %52 ], !dbg !200
  call void @llvm.dbg.value(metadata i32 %57, metadata !100, metadata !DIExpression()), !dbg !200
  call void @llvm.dbg.value(metadata i32 %56, metadata !101, metadata !DIExpression()), !dbg !200
  call void @llvm.dbg.label(metadata !199), !dbg !271
  %58 = getelementptr inbounds [14 x i8], [14 x i8]* %3, i64 0, i64 0, !dbg !272
  call void @llvm.lifetime.start.p0i8(i64 14, i8* nonnull %58) #3, !dbg !272
  call void @llvm.dbg.declare(metadata [14 x i8]* %3, metadata !194, metadata !DIExpression()), !dbg !272
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 1 dereferenceable(14) %58, i8* nonnull align 1 dereferenceable(14) getelementptr inbounds ([14 x i8], [14 x i8]* @__const.xdp_parse_prog.____fmt, i64 0, i64 0), i64 14, i1 false), !dbg !272
  %59 = call i32 (i8*, i32, ...) inttoptr (i64 6 to i32 (i8*, i32, ...)*)(i8* nonnull %58, i32 14, i32 %56) #3, !dbg !272
  call void @llvm.lifetime.end.p0i8(i64 14, i8* nonnull %58) #3, !dbg !273
  %60 = bitcast i32* %2 to i8*, !dbg !274
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %60), !dbg !274
  call void @llvm.dbg.value(metadata %struct.xdp_md* %0, metadata !279, metadata !DIExpression()) #3, !dbg !274
  call void @llvm.dbg.value(metadata i32 %57, metadata !280, metadata !DIExpression()) #3, !dbg !274
  call void @llvm.dbg.value(metadata i32 %56, metadata !281, metadata !DIExpression()) #3, !dbg !274
  store i32 %56, i32* %2, align 4, !tbaa !294
  %61 = load i32, i32* %8, align 4, !dbg !295, !tbaa !210
  %62 = zext i32 %61 to i64, !dbg !296
  call void @llvm.dbg.value(metadata i64 %62, metadata !282, metadata !DIExpression()) #3, !dbg !274
  %63 = load i32, i32* %4, align 4, !dbg !297, !tbaa !202
  %64 = zext i32 %63 to i64, !dbg !298
  call void @llvm.dbg.value(metadata i64 %64, metadata !283, metadata !DIExpression()) #3, !dbg !274
  %65 = icmp ugt i32 %56, 5, !dbg !299
  br i1 %65, label %78, label %66, !dbg !301

66:                                               ; preds = %55
  call void @llvm.dbg.value(metadata i32* %2, metadata !281, metadata !DIExpression(DW_OP_deref)) #3, !dbg !274
  %67 = call i8* inttoptr (i64 1 to i8* (i8*, i8*)*)(i8* bitcast (%struct.bpf_map_def* @xdp_stats_map to i8*), i8* nonnull %60) #3, !dbg !302
  call void @llvm.dbg.value(metadata i8* %67, metadata !284, metadata !DIExpression()) #3, !dbg !274
  %68 = icmp eq i8* %67, null, !dbg !303
  br i1 %68, label %78, label %69, !dbg !305

69:                                               ; preds = %66
  call void @llvm.dbg.value(metadata i8* %67, metadata !284, metadata !DIExpression()) #3, !dbg !274
  %70 = sub nsw i64 %62, %64, !dbg !306
  call void @llvm.dbg.value(metadata i64 %70, metadata !292, metadata !DIExpression()) #3, !dbg !274
  %71 = bitcast i8* %67 to i64*, !dbg !307
  %72 = load i64, i64* %71, align 8, !dbg !308, !tbaa !309
  %73 = add i64 %72, 1, !dbg !308
  store i64 %73, i64* %71, align 8, !dbg !308, !tbaa !309
  %74 = getelementptr inbounds i8, i8* %67, i64 8, !dbg !312
  %75 = bitcast i8* %74 to i64*, !dbg !312
  %76 = load i64, i64* %75, align 8, !dbg !313, !tbaa !314
  %77 = add i64 %70, %76, !dbg !313
  store i64 %77, i64* %75, align 8, !dbg !313, !tbaa !314
  br label %78

78:                                               ; preds = %55, %66, %69
  %79 = phi i32 [ %57, %69 ], [ 0, %55 ], [ 0, %66 ], !dbg !274
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %60), !dbg !315
  br label %80, !dbg !316

80:                                               ; preds = %19, %1, %78
  %81 = phi i32 [ %79, %78 ], [ -1, %1 ], [ -1, %19 ], !dbg !200
  ret i32 %81, !dbg !317
}
...
!3 = !DIFile(filename: "xdp_test_ip_ttl_min.c", directory: "/home/aino/Projects/xapture/filter/filter-test")
!4 = !{!5, !14}
...
!255 = !DILocation(line: 117, column: 11, scope: !256)
!256 = distinct !DILexicalBlock(scope: !85, file: !3, line: 117, column: 6)
!257 = !{!233, !205, i64 8}
!258 = !DILocation(line: 117, column: 15, scope: !256)
!259 = !DILocation(line: 117, column: 6, scope: !85)
!260 = !DILocation(line: 123, column: 15, scope: !261)
!261 = distinct !DILexicalBlock(scope: !85, file: !3, line: 123, column: 6)
!262 = !DILocation(line: 123, column: 6, scope: !85)
!263 = !DILocation(line: 129, column: 15, scope: !264)
!264 = distinct !DILexicalBlock(scope: !85, file: !3, line: 129, column: 6)
!265 = !DILocation(line: 129, column: 6, scope: !85)
!266 = !DILocation(line: 135, column: 15, scope: !267)
!267 = distinct !DILexicalBlock(scope: !85, file: !3, line: 135, column: 6)
!268 = !DILocation(line: 135, column: 6, scope: !85)
!269 = !DILocation(line: 141, column: 15, scope: !270)
!270 = distinct !DILexicalBlock(scope: !85, file: !3, line: 141, column: 6)
!271 = !DILocation(line: 146, column: 1, scope: !85)
!272 = !DILocation(line: 147, column: 2, scope: !195)
!273 = !DILocation(line: 147, column: 2, scope: !85)
!274 = !DILocation(line: 0, scope: !275, inlinedAt: !293)
!275 = distinct !DISubprogram(name: "xdp_stats_func", scope: !3, file: !3, line: 32, type: !276, scopeLine: 32, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !278)
!276 = !DISubroutineType(types: !277)
!277 = !{!65, !88, !65, !65}
!278 = !{!279, !280, !281, !282, !283, !284, !292}
!279 = !DILocalVariable(name: "ctx", arg: 1, scope: !275, file: !3, line: 32, type: !88)
!280 = !DILocalVariable(name: "action", arg: 2, scope: !275, file: !3, line: 32, type: !65)
!281 = !DILocalVariable(name: "priority", arg: 3, scope: !275, file: !3, line: 32, type: !65)
!282 = !DILocalVariable(name: "data_end", scope: !275, file: !3, line: 33, type: !44)
!283 = !DILocalVariable(name: "data", scope: !275, file: !3, line: 34, type: !44)
!284 = !DILocalVariable(name: "rec", scope: !275, file: !3, line: 35, type: !285)
!285 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !286, size: 64)
!286 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "datarec", file: !3, line: 16, size: 128, elements: !287)
!287 = !{!288, !291}
!288 = !DIDerivedType(tag: DW_TAG_member, name: "rx_packets", scope: !286, file: !3, line: 17, baseType: !289, size: 64)
!289 = !DIDerivedType(tag: DW_TAG_typedef, name: "__u64", file: !47, line: 31, baseType: !290)
!290 = !DIBasicType(name: "long long unsigned int", size: 64, encoding: DW_ATE_unsigned)
!291 = !DIDerivedType(tag: DW_TAG_member, name: "rx_bytes", scope: !286, file: !3, line: 18, baseType: !289, size: 64, offset: 64)
!292 = !DILocalVariable(name: "bytes", scope: !275, file: !3, line: 52, type: !289)
!293 = distinct !DILocation(line: 148, column: 9, scope: !85)
!294 = !{!204, !204, i64 0}
!295 = !DILocation(line: 33, column: 37, scope: !275, inlinedAt: !293)
!296 = !DILocation(line: 33, column: 26, scope: !275, inlinedAt: !293)
!297 = !DILocation(line: 34, column: 33, scope: !275, inlinedAt: !293)
!298 = !DILocation(line: 34, column: 22, scope: !275, inlinedAt: !293)
!299 = !DILocation(line: 41, column: 15, scope: !300, inlinedAt: !293)
!300 = distinct !DILexicalBlock(scope: !275, file: !3, line: 41, column: 6)
!301 = !DILocation(line: 37, column: 6, scope: !275, inlinedAt: !293)
!302 = !DILocation(line: 46, column: 8, scope: !275, inlinedAt: !293)
!303 = !DILocation(line: 47, column: 7, scope: !304, inlinedAt: !293)
!304 = distinct !DILexicalBlock(scope: !275, file: !3, line: 47, column: 6)
!305 = !DILocation(line: 47, column: 6, scope: !275, inlinedAt: !293)
!306 = !DILocation(line: 52, column: 25, scope: !275, inlinedAt: !293)
!307 = !DILocation(line: 53, column: 7, scope: !275, inlinedAt: !293)
!308 = !DILocation(line: 53, column: 17, scope: !275, inlinedAt: !293)
!309 = !{!310, !311, i64 0}
!310 = !{!"datarec", !311, i64 0, !311, i64 8}
!311 = !{!"long long", !205, i64 0}
!312 = !DILocation(line: 54, column: 7, scope: !275, inlinedAt: !293)
!313 = !DILocation(line: 54, column: 16, scope: !275, inlinedAt: !293)
!314 = !{!310, !311, i64 8}
!315 = !DILocation(line: 57, column: 1, scope: !275, inlinedAt: !293)
!316 = !DILocation(line: 148, column: 2, scope: !85)
!317 = !DILocation(line: 149, column: 1, scope: !85)
