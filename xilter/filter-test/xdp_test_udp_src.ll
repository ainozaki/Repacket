; ModuleID = 'xdp_test_udp_src.c'
source_filename = "xdp_test_udp_src.c"
...
15:                                               ; preds = %1
  ...
  br i1 %18, label %19, label %51, !dbg !224
...
27:                                               ; preds = %24
  ...
  br i1 %31, label %51, label %46, !dbg !240
...
32:                                               ; preds = %24
  ...
  br i1 %36, label %51, label %42, !dbg !247
...
37:                                               ; preds = %24
  ...
  br i1 %41, label %51, label %46, !dbg !254
...
42:                                               ; preds = %32
  ...
  call void @llvm.dbg.value(metadata i8* %20, metadata !161, metadata !DIExpression()), !dbg !200
  call void @llvm.dbg.value(metadata i8* %20, metadata !161, metadata !DIExpression()), !dbg !200
  %43 = bitcast i8* %20 to i16*, !dbg !255
  %44 = load i16, i16* %43, align 2, !dbg !255, !tbaa !257
...
51:                                               ; preds = %42, %50, %49, %48, %47, %37, %32, %27, %15, %46
  %52 = phi i32 [ 0, %15 ], [ 1, %42 ], [ 6, %46 ], [ 0, %27 ], [ 0, %32 ], [ 0, %37 ], [ 2, %47 ], [ 3, %48 ], [ 4, %49 ], [ 5, %50 ], !dbg !200
  %53 = phi i32 [ 2, %15 ], [ 2, %42 ], [ 2, %46 ], [ 0, %27 ], [ 0, %32 ], [ 0, %37 ], [ 2, %47 ], [ 2, %48 ], [ 2, %49 ], [ 2, %50 ], !dbg !200
  call void @llvm.dbg.value(metadata i32 %53, metadata !100, metadata !DIExpression()), !dbg !200
  call void @llvm.dbg.value(metadata i32 %52, metadata !101, metadata !DIExpression()), !dbg !200
  call void @llvm.dbg.label(metadata !199), !dbg !262
  %54 = getelementptr inbounds [14 x i8], [14 x i8]* %3, i64 0, i64 0, !dbg !261
  call void @llvm.lifetime.start.p0i8(i64 14, i8* nonnull %54) #3, !dbg !261
  call void @llvm.dbg.declare(metadata [14 x i8]* %3, metadata !194, metadata !DIExpression()), !dbg !261
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 1 dereferenceable(14) %54, i8* nonnull align 1 dereferenceable(14) getelementptr inbounds ([14 x i8], [14 x i8]* @__const.xdp_parse_prog.____fmt, i64 0, i64 0), i64 14, i1 false), !dbg !261
  %55 = call i32 (i8*, i32, ...) inttoptr (i64 6 to i32 (i8*, i32, ...)*)(i8* nonnull %54, i32 14, i32 %52) #3, !dbg !261
  call void @llvm.lifetime.end.p0i8(i64 14, i8* nonnull %54) #3, !dbg !263
  %56 = bitcast i32* %2 to i8*, !dbg !264
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %56), !dbg !264
  call void @llvm.dbg.value(metadata %struct.xdp_md* %0, metadata !269, metadata !DIExpression()) #3, !dbg !264
  call void @llvm.dbg.value(metadata i32 %53, metadata !270, metadata !DIExpression()) #3, !dbg !264
  call void @llvm.dbg.value(metadata i32 %52, metadata !271, metadata !DIExpression()) #3, !dbg !264
  store i32 %52, i32* %2, align 4, !tbaa !284
  %57 = load i32, i32* %8, align 4, !dbg !285, !tbaa !210
  %58 = zext i32 %57 to i64, !dbg !286
  call void @llvm.dbg.value(metadata i64 %58, metadata !272, metadata !DIExpression()) #3, !dbg !264
  %59 = load i32, i32* %4, align 4, !dbg !287, !tbaa !202
  %60 = zext i32 %59 to i64, !dbg !288
  call void @llvm.dbg.value(metadata i64 %60, metadata !273, metadata !DIExpression()) #3, !dbg !264
  %61 = icmp ugt i32 %52, 5, !dbg !289
  br i1 %61, label %74, label %62, !dbg !291

62:                                               ; preds = %51
  call void @llvm.dbg.value(metadata i32* %2, metadata !271, metadata !DIExpression(DW_OP_deref)) #3, !dbg !264
  %63 = call i8* inttoptr (i64 1 to i8* (i8*, i8*)*)(i8* bitcast (%struct.bpf_map_def* @xdp_stats_map to i8*), i8* nonnull %56) #3, !dbg !292
  call void @llvm.dbg.value(metadata i8* %63, metadata !274, metadata !DIExpression()) #3, !dbg !264
  %64 = icmp eq i8* %63, null, !dbg !293
  br i1 %64, label %74, label %65, !dbg !295

65:                                               ; preds = %62
  call void @llvm.dbg.value(metadata i8* %63, metadata !274, metadata !DIExpression()) #3, !dbg !264
  %66 = sub nsw i64 %58, %60, !dbg !296
  call void @llvm.dbg.value(metadata i64 %66, metadata !282, metadata !DIExpression()) #3, !dbg !264
  %67 = bitcast i8* %63 to i64*, !dbg !297
  %68 = load i64, i64* %67, align 8, !dbg !298, !tbaa !299
  %69 = add i64 %68, 1, !dbg !298
  store i64 %69, i64* %67, align 8, !dbg !298, !tbaa !299
  %70 = getelementptr inbounds i8, i8* %63, i64 8, !dbg !302
  %71 = bitcast i8* %70 to i64*, !dbg !302
  %72 = load i64, i64* %71, align 8, !dbg !303, !tbaa !304
  %73 = add i64 %66, %72, !dbg !303
  store i64 %73, i64* %71, align 8, !dbg !303, !tbaa !304
  br label %74

74:                                               ; preds = %51, %62, %65
  %75 = phi i32 [ %53, %65 ], [ 0, %51 ], [ 0, %62 ], !dbg !264
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %56), !dbg !305
  br label %76, !dbg !306
...
!3 = !DIFile(filename: "xdp_test_udp_src.c", directory: "/home/aino/Projects/xapture/filter/filter-test")
!4 = !{!5, !14}
...
!257 = !{!258, !222, i64 0}
!258 = !{!"udphdr", !222, i64 0, !222, i64 2, !222, i64 4, !222, i64 6}
