; ModuleID = 'xdp_test_ip_ttl_max.c'
source_filename = "xdp_test_ip_ttl_max.c"
...
define dso_local i32 @xdp_parse_prog(%struct.xdp_md* nocapture readonly %0) #0 section "xdp_generated" !dbg !85 {
  ...
  br i1 %14, label %76, label %15, !dbg !217
...
15:                                               ; preds = %1
  ...
  br i1 %18, label %19, label %53, !dbg !224
...
19:                                               ; preds = %15
  ...
  br i1 %23, label %76, label %24, !dbg !229
...
27:                                               ; preds = %24
  ...
  br i1 %31, label %53, label %42, !dbg !240
...
32:                                               ; preds = %24
  ...
  br i1 %36, label %53, label %42, !dbg !247
...
37:                                               ; preds = %24
  ...
  br i1 %41, label %53, label %42, !dbg !254
...
42:                                               ; preds = %37, %24, %32, %27
  ...
  %45 = icmp ult i8 %44, 2, !dbg !258
  br i1 %45, label %53, label %46, !dbg !259

46:                                               ; preds = %42
  call void @llvm.dbg.value(metadata i32 2, metadata !101, metadata !DIExpression()), !dbg !200
  %47 = icmp ult i8 %44, 17, !dbg !260
  br i1 %47, label %53, label %48, !dbg !262

48:                                               ; preds = %46
  call void @llvm.dbg.value(metadata i32 3, metadata !101, metadata !DIExpression()), !dbg !200
  %49 = icmp ult i8 %44, 33, !dbg !263
  br i1 %49, label %53, label %50, !dbg !265

50:                                               ; preds = %48
  call void @llvm.dbg.value(metadata i32 4, metadata !101, metadata !DIExpression()), !dbg !200
  %51 = icmp ult i8 %44, 65, !dbg !266
  %52 = select i1 %51, i32 4, i32 5, !dbg !268
  br label %53, !dbg !268

53:                                               ; preds = %50, %37, %32, %27, %15, %48, %46, %42
  %54 = phi i32 [ 0, %15 ], [ 1, %42 ], [ 2, %46 ], [ 3, %48 ], [ 0, %27 ], [ 0, %32 ], [ 0, %37 ], [ %52, %50 ], !dbg !200
  %55 = phi i32 [ 2, %15 ], [ 2, %42 ], [ 2, %46 ], [ 2, %48 ], [ 0, %27 ], [ 0, %32 ], [ 0, %37 ], [ 2, %50 ], !dbg !200
  call void @llvm.dbg.value(metadata i32 %55, metadata !100, metadata !DIExpression()), !dbg !200
  call void @llvm.dbg.value(metadata i32 %54, metadata !101, metadata !DIExpression()), !dbg !200
  call void @llvm.dbg.label(metadata !199), !dbg !269
  %56 = getelementptr inbounds [14 x i8], [14 x i8]* %3, i64 0, i64 0, !dbg !270
  call void @llvm.lifetime.start.p0i8(i64 14, i8* nonnull %56) #3, !dbg !270
  call void @llvm.dbg.declare(metadata [14 x i8]* %3, metadata !194, metadata !DIExpression()), !dbg !270
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 1 dereferenceable(14) %56, i8* nonnull align 1 dereferenceable(14) getelementptr inbounds ([14 x i8], [14 x i8]* @__const.xdp_parse_prog.____fmt, i64 0, i64 0), i64 14, i1 false), !dbg !270
  %57 = call i32 (i8*, i32, ...) inttoptr (i64 6 to i32 (i8*, i32, ...)*)(i8* nonnull %56, i32 14, i32 %54) #3, !dbg !270
  call void @llvm.lifetime.end.p0i8(i64 14, i8* nonnull %56) #3, !dbg !271
  %58 = bitcast i32* %2 to i8*, !dbg !272
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %58), !dbg !272
  call void @llvm.dbg.value(metadata %struct.xdp_md* %0, metadata !277, metadata !DIExpression()) #3, !dbg !272
  call void @llvm.dbg.value(metadata i32 %55, metadata !278, metadata !DIExpression()) #3, !dbg !272
  call void @llvm.dbg.value(metadata i32 %54, metadata !279, metadata !DIExpression()) #3, !dbg !272
  store i32 %54, i32* %2, align 4, !tbaa !292
  %59 = load i32, i32* %8, align 4, !dbg !293, !tbaa !210
  call void @llvm.dbg.value(metadata i32 %59, metadata !280, metadata !DIExpression()) #3, !dbg !272
  %60 = load i32, i32* %4, align 4, !dbg !294, !tbaa !202
  call void @llvm.dbg.value(metadata i32 %60, metadata !281, metadata !DIExpression()) #3, !dbg !272
  call void @llvm.dbg.value(metadata i32* %2, metadata !279, metadata !DIExpression(DW_OP_deref)) #3, !dbg !272
  %61 = call i8* inttoptr (i64 1 to i8* (i8*, i8*)*)(i8* bitcast (%struct.bpf_map_def* @xdp_stats_map to i8*), i8* nonnull %58) #3, !dbg !295
  call void @llvm.dbg.value(metadata i8* %61, metadata !282, metadata !DIExpression()) #3, !dbg !272
  %62 = icmp eq i8* %61, null, !dbg !296
  br i1 %62, label %74, label %63, !dbg !298

63:                                               ; preds = %53
  %64 = zext i32 %60 to i64, !dbg !299
  call void @llvm.dbg.value(metadata i64 %64, metadata !281, metadata !DIExpression()) #3, !dbg !272
  %65 = zext i32 %59 to i64, !dbg !300
  call void @llvm.dbg.value(metadata i64 %65, metadata !280, metadata !DIExpression()) #3, !dbg !272
  call void @llvm.dbg.value(metadata i8* %61, metadata !282, metadata !DIExpression()) #3, !dbg !272
  %66 = sub nsw i64 %65, %64, !dbg !301
  call void @llvm.dbg.value(metadata i64 %66, metadata !290, metadata !DIExpression()) #3, !dbg !272
  %67 = bitcast i8* %61 to i64*, !dbg !302
  %68 = load i64, i64* %67, align 8, !dbg !303, !tbaa !304
  %69 = add i64 %68, 1, !dbg !303
  store i64 %69, i64* %67, align 8, !dbg !303, !tbaa !304
  %70 = getelementptr inbounds i8, i8* %61, i64 8, !dbg !307
  %71 = bitcast i8* %70 to i64*, !dbg !307
  %72 = load i64, i64* %71, align 8, !dbg !308, !tbaa !309
  %73 = add i64 %66, %72, !dbg !308
  store i64 %73, i64* %71, align 8, !dbg !308, !tbaa !309
  br label %74

74:                                               ; preds = %53, %63
  %75 = phi i32 [ %55, %63 ], [ 0, %53 ], !dbg !272
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %58), !dbg !310
  br label %76, !dbg !311

76:                                               ; preds = %19, %1, %74
  %77 = phi i32 [ %75, %74 ], [ -1, %1 ], [ -1, %19 ], !dbg !200
  ret i32 %77, !dbg !312
}
...
!3 = !DIFile(filename: "xdp_test_ip_ttl_max.c", directory: "/home/aino/Projects/xapture/filter/filter-test")
!4 = !{!5, !14}
...
!269 = !DILocation(line: 146, column: 1, scope: !85)
!270 = !DILocation(line: 147, column: 2, scope: !195)
!271 = !DILocation(line: 147, column: 2, scope: !85)
!272 = !DILocation(line: 0, scope: !273, inlinedAt: !291)
!273 = distinct !DISubprogram(name: "xdp_stats_func", scope: !3, file: !3, line: 32, type: !274, scopeLine: 32, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !2, retainedNodes: !276)
!274 = !DISubroutineType(types: !275)
!275 = !{!65, !88, !65, !65}
!276 = !{!277, !278, !279, !280, !281, !282, !290}
!277 = !DILocalVariable(name: "ctx", arg: 1, scope: !273, file: !3, line: 32, type: !88)
!278 = !DILocalVariable(name: "action", arg: 2, scope: !273, file: !3, line: 32, type: !65)
!279 = !DILocalVariable(name: "priority", arg: 3, scope: !273, file: !3, line: 32, type: !65)
!280 = !DILocalVariable(name: "data_end", scope: !273, file: !3, line: 33, type: !44)
!281 = !DILocalVariable(name: "data", scope: !273, file: !3, line: 34, type: !44)
!282 = !DILocalVariable(name: "rec", scope: !273, file: !3, line: 35, type: !283)
!283 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !284, size: 64)
!284 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "datarec", file: !3, line: 16, size: 128, elements: !285)
!285 = !{!286, !289}
!286 = !DIDerivedType(tag: DW_TAG_member, name: "rx_packets", scope: !284, file: !3, line: 17, baseType: !287, size: 64)
!287 = !DIDerivedType(tag: DW_TAG_typedef, name: "__u64", file: !47, line: 31, baseType: !288)
!288 = !DIBasicType(name: "long long unsigned int", size: 64, encoding: DW_ATE_unsigned)
!289 = !DIDerivedType(tag: DW_TAG_member, name: "rx_bytes", scope: !284, file: !3, line: 18, baseType: !287, size: 64, offset: 64)
!290 = !DILocalVariable(name: "bytes", scope: !273, file: !3, line: 52, type: !287)
!291 = distinct !DILocation(line: 148, column: 9, scope: !85)
!292 = !{!204, !204, i64 0}
!293 = !DILocation(line: 33, column: 37, scope: !273, inlinedAt: !291)
!294 = !DILocation(line: 34, column: 33, scope: !273, inlinedAt: !291)
!295 = !DILocation(line: 46, column: 8, scope: !273, inlinedAt: !291)
!296 = !DILocation(line: 47, column: 7, scope: !297, inlinedAt: !291)
!297 = distinct !DILexicalBlock(scope: !273, file: !3, line: 47, column: 6)
!298 = !DILocation(line: 47, column: 6, scope: !273, inlinedAt: !291)
!299 = !DILocation(line: 34, column: 22, scope: !273, inlinedAt: !291)
!300 = !DILocation(line: 33, column: 26, scope: !273, inlinedAt: !291)
!301 = !DILocation(line: 52, column: 25, scope: !273, inlinedAt: !291)
!302 = !DILocation(line: 53, column: 7, scope: !273, inlinedAt: !291)
!303 = !DILocation(line: 53, column: 17, scope: !273, inlinedAt: !291)
!304 = !{!305, !306, i64 0}
!305 = !{!"datarec", !306, i64 0, !306, i64 8}
!306 = !{!"long long", !205, i64 0}
!307 = !DILocation(line: 54, column: 7, scope: !273, inlinedAt: !291)
!308 = !DILocation(line: 54, column: 16, scope: !273, inlinedAt: !291)
!309 = !{!305, !306, i64 8}
!310 = !DILocation(line: 57, column: 1, scope: !273, inlinedAt: !291)
!311 = !DILocation(line: 148, column: 2, scope: !85)
!312 = !DILocation(line: 149, column: 1, scope: !85)
