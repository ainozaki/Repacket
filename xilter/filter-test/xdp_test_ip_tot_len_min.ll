; ModuleID = 'xdp_test_ip_tot_len_min.c'
source_filename = "xdp_test_ip_tot_len_min.c"
...
define dso_local i32 @xdp_parse_prog(%struct.xdp_md* nocapture readonly %0) #0 section "xdp_generated" !dbg !85 {
  ...
  br i1 %14, label %82, label %15, !dbg !217
...
15:                                               ; preds = %1
  ...
  br i1 %18, label %19, label %57, !dbg !224
...
19:                                               ; preds = %15
  ...
  br i1 %23, label %82, label %24, !dbg !229
...
27:                                               ; preds = %24
  ...
  br i1 %31, label %57, label %42, !dbg !240
...
32:                                               ; preds = %24
  ...
  br i1 %36, label %57, label %42, !dbg !247
...
37:                                               ; preds = %24
  ...
  br i1 %41, label %57, label %42, !dbg !254

42:                                               ; preds = %37, %24, %32, %27
  call void @llvm.dbg.value(metadata i32 1, metadata !101, metadata !DIExpression()), !dbg !200
  %43 = getelementptr i8, i8* %7, i64 16, !dbg !255
  %44 = bitcast i8* %43 to i16*, !dbg !255
  %45 = load i16, i16* %44, align 2, !dbg !255, !tbaa !257
  %46 = tail call i16 @llvm.bswap.i16(i16 %45)
  %47 = icmp ugt i16 %46, 1499, !dbg !258
  br i1 %47, label %57, label %48, !dbg !259

48:                                               ; preds = %42
  call void @llvm.dbg.value(metadata i32 2, metadata !101, metadata !DIExpression()), !dbg !200
  %49 = icmp ugt i16 %46, 1023, !dbg !260
  br i1 %49, label %57, label %50, !dbg !262

50:                                               ; preds = %48
  call void @llvm.dbg.value(metadata i32 3, metadata !101, metadata !DIExpression()), !dbg !200
  %51 = icmp ugt i16 %46, 511, !dbg !263
  br i1 %51, label %57, label %52, !dbg !265

52:                                               ; preds = %50
  call void @llvm.dbg.value(metadata i32 4, metadata !101, metadata !DIExpression()), !dbg !200
  %53 = icmp ugt i16 %46, 127, !dbg !266
  br i1 %53, label %57, label %54, !dbg !268

54:                                               ; preds = %52
  call void @llvm.dbg.value(metadata i32 5, metadata !101, metadata !DIExpression()), !dbg !200
  %55 = icmp ugt i16 %46, 63, !dbg !269
  %56 = select i1 %55, i32 5, i32 6
  br label %57

57:                                               ; preds = %54, %37, %32, %27, %15, %52, %50, %48, %42
  %58 = phi i32 [ 0, %15 ], [ 1, %42 ], [ 2, %48 ], [ 3, %50 ], [ 4, %52 ], [ 0, %27 ], [ 0, %32 ], [ 0, %37 ], [ %56, %54 ], !dbg !200
  %59 = phi i32 [ 2, %15 ], [ 2, %42 ], [ 2, %48 ], [ 2, %50 ], [ 2, %52 ], [ 0, %27 ], [ 0, %32 ], [ 0, %37 ], [ 2, %54 ], !dbg !200
  call void @llvm.dbg.value(metadata i32 %59, metadata !100, metadata !DIExpression()), !dbg !200
  call void @llvm.dbg.value(metadata i32 %58, metadata !101, metadata !DIExpression()), !dbg !200
  call void @llvm.dbg.label(metadata !199), !dbg !271
  %60 = getelementptr inbounds [14 x i8], [14 x i8]* %3, i64 0, i64 0, !dbg !272
  call void @llvm.lifetime.start.p0i8(i64 14, i8* nonnull %60) #3, !dbg !272
  call void @llvm.dbg.declare(metadata [14 x i8]* %3, metadata !194, metadata !DIExpression()), !dbg !272
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 1 dereferenceable(14) %60, i8* nonnull align 1 dereferenceable(14) getelementptr inbounds ([14 x i8], [14 x i8]* @__const.xdp_parse_prog.____fmt, i64 0, i64 0), i64 14, i1 false), !dbg !272
  %61 = call i32 (i8*, i32, ...) inttoptr (i64 6 to i32 (i8*, i32, ...)*)(i8* nonnull %60, i32 14, i32 %58) #3, !dbg !272
  call void @llvm.lifetime.end.p0i8(i64 14, i8* nonnull %60) #3, !dbg !273
  %62 = bitcast i32* %2 to i8*, !dbg !274
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %62), !dbg !274
  call void @llvm.dbg.value(metadata %struct.xdp_md* %0, metadata !279, metadata !DIExpression()) #3, !dbg !274
  call void @llvm.dbg.value(metadata i32 %59, metadata !280, metadata !DIExpression()) #3, !dbg !274
  call void @llvm.dbg.value(metadata i32 %58, metadata !281, metadata !DIExpression()) #3, !dbg !274
  store i32 %58, i32* %2, align 4, !tbaa !294
  %63 = load i32, i32* %8, align 4, !dbg !295, !tbaa !210
  %64 = zext i32 %63 to i64, !dbg !296
  call void @llvm.dbg.value(metadata i64 %64, metadata !282, metadata !DIExpression()) #3, !dbg !274
  %65 = load i32, i32* %4, align 4, !dbg !297, !tbaa !202
  %66 = zext i32 %65 to i64, !dbg !298
  call void @llvm.dbg.value(metadata i64 %66, metadata !283, metadata !DIExpression()) #3, !dbg !274
  %67 = icmp ugt i32 %58, 5, !dbg !299
  br i1 %67, label %80, label %68, !dbg !301

68:                                               ; preds = %57
  call void @llvm.dbg.value(metadata i32* %2, metadata !281, metadata !DIExpression(DW_OP_deref)) #3, !dbg !274
  %69 = call i8* inttoptr (i64 1 to i8* (i8*, i8*)*)(i8* bitcast (%struct.bpf_map_def* @xdp_stats_map to i8*), i8* nonnull %62) #3, !dbg !302
  call void @llvm.dbg.value(metadata i8* %69, metadata !284, metadata !DIExpression()) #3, !dbg !274
  %70 = icmp eq i8* %69, null, !dbg !303
  br i1 %70, label %80, label %71, !dbg !305

71:                                               ; preds = %68
  call void @llvm.dbg.value(metadata i8* %69, metadata !284, metadata !DIExpression()) #3, !dbg !274
  %72 = sub nsw i64 %64, %66, !dbg !306
  call void @llvm.dbg.value(metadata i64 %72, metadata !292, metadata !DIExpression()) #3, !dbg !274
  %73 = bitcast i8* %69 to i64*, !dbg !307
  %74 = load i64, i64* %73, align 8, !dbg !308, !tbaa !309
  %75 = add i64 %74, 1, !dbg !308
  store i64 %75, i64* %73, align 8, !dbg !308, !tbaa !309
  %76 = getelementptr inbounds i8, i8* %69, i64 8, !dbg !312
  %77 = bitcast i8* %76 to i64*, !dbg !312
  %78 = load i64, i64* %77, align 8, !dbg !313, !tbaa !314
  %79 = add i64 %72, %78, !dbg !313
  store i64 %79, i64* %77, align 8, !dbg !313, !tbaa !314
  br label %80

80:                                               ; preds = %57, %68, %71
  %81 = phi i32 [ %59, %71 ], [ 0, %57 ], [ 0, %68 ], !dbg !274
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %62), !dbg !315
  br label %82, !dbg !316

82:                                               ; preds = %19, %1, %80
  %83 = phi i32 [ %81, %80 ], [ -1, %1 ], [ -1, %19 ], !dbg !200
  ret i32 %83, !dbg !317
}
...
!3 = !DIFile(filename: "xdp_test_ip_tot_len_min.c", directory: "/home/aino/Projects/xapture/filter/filter-test")
!4 = !{!5, !14}
