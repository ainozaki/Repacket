; ModuleID = 'xdp_test_icmp_type.c'
source_filename = "xdp_test_icmp_type.c"
...
define dso_local i32 @xdp_parse_prog(%struct.xdp_md* nocapture readonly %0) #0 section "xdp_generated" !dbg !85 {
  ...
  br i1 %14, label %74, label %15, !dbg !217
...
15:                                               ; preds = %1
  ...
  br i1 %18, label %19, label %49, !dbg !224
...
19:                                               ; preds = %15
  ...
  br i1 %23, label %74, label %24, !dbg !229
...
27:                                               ; preds = %24
  ...
  br i1 %31, label %49, label %44, !dbg !240
...
32:                                               ; preds = %24
  ...
  br i1 %36, label %49, label %44, !dbg !247
...
37:                                               ; preds = %24
  ...
  br i1 %41, label %49, label %42, !dbg !254
...
42:                                               ; preds = %37
  ...
  call void @llvm.dbg.value(metadata i8* %20, metadata !170, metadata !DIExpression()), !dbg !200
  call void @llvm.dbg.value(metadata i8* %20, metadata !170, metadata !DIExpression()), !dbg !200
  %43 = load i8, i8* %20, align 4, !dbg !255, !tbaa !257
...
49:                                               ; preds = %42, %48, %47, %46, %45, %37, %32, %27, %15, %44
  %50 = phi i32 [ 0, %15 ], [ 1, %42 ], [ 6, %44 ], [ 0, %27 ], [ 0, %32 ], [ 0, %37 ], [ 2, %45 ], [ 3, %46 ], [ 4, %47 ], [ 5, %48 ], !dbg !200
  %51 = phi i32 [ 2, %15 ], [ 2, %42 ], [ 2, %44 ], [ 0, %27 ], [ 0, %32 ], [ 0, %37 ], [ 2, %45 ], [ 2, %46 ], [ 2, %47 ], [ 2, %48 ], !dbg !200
  call void @llvm.dbg.value(metadata i32 %51, metadata !100, metadata !DIExpression()), !dbg !200
  call void @llvm.dbg.value(metadata i32 %50, metadata !101, metadata !DIExpression()), !dbg !200
  call void @llvm.dbg.label(metadata !199), !dbg !262
  %52 = getelementptr inbounds [14 x i8], [14 x i8]* %3, i64 0, i64 0, !dbg !261
  call void @llvm.lifetime.start.p0i8(i64 14, i8* nonnull %52) #3, !dbg !261
  call void @llvm.dbg.declare(metadata [14 x i8]* %3, metadata !194, metadata !DIExpression()), !dbg !261
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 1 dereferenceable(14) %52, i8* nonnull align 1 dereferenceable(14) getelementptr inbounds ([14 x i8], [14 x i8]* @__const.xdp_parse_prog.____fmt, i64 0, i64 0), i64 14, i1 false), !dbg !261
  %53 = call i32 (i8*, i32, ...) inttoptr (i64 6 to i32 (i8*, i32, ...)*)(i8* nonnull %52, i32 14, i32 %50) #3, !dbg !261
  call void @llvm.lifetime.end.p0i8(i64 14, i8* nonnull %52) #3, !dbg !263
  %54 = bitcast i32* %2 to i8*, !dbg !264
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %54), !dbg !264
  call void @llvm.dbg.value(metadata %struct.xdp_md* %0, metadata !269, metadata !DIExpression()) #3, !dbg !264
  call void @llvm.dbg.value(metadata i32 %51, metadata !270, metadata !DIExpression()) #3, !dbg !264
  call void @llvm.dbg.value(metadata i32 %50, metadata !271, metadata !DIExpression()) #3, !dbg !264
  store i32 %50, i32* %2, align 4, !tbaa !284
  %55 = load i32, i32* %8, align 4, !dbg !285, !tbaa !210
  %56 = zext i32 %55 to i64, !dbg !286
  call void @llvm.dbg.value(metadata i64 %56, metadata !272, metadata !DIExpression()) #3, !dbg !264
  %57 = load i32, i32* %4, align 4, !dbg !287, !tbaa !202
  %58 = zext i32 %57 to i64, !dbg !288
  call void @llvm.dbg.value(metadata i64 %58, metadata !273, metadata !DIExpression()) #3, !dbg !264
  %59 = icmp ugt i32 %50, 5, !dbg !289
  br i1 %59, label %72, label %60, !dbg !291

60:                                               ; preds = %49
  call void @llvm.dbg.value(metadata i32* %2, metadata !271, metadata !DIExpression(DW_OP_deref)) #3, !dbg !264
  %61 = call i8* inttoptr (i64 1 to i8* (i8*, i8*)*)(i8* bitcast (%struct.bpf_map_def* @xdp_stats_map to i8*), i8* nonnull %54) #3, !dbg !292
  call void @llvm.dbg.value(metadata i8* %61, metadata !274, metadata !DIExpression()) #3, !dbg !264
  %62 = icmp eq i8* %61, null, !dbg !293
  br i1 %62, label %72, label %63, !dbg !295

63:                                               ; preds = %60
  call void @llvm.dbg.value(metadata i8* %61, metadata !274, metadata !DIExpression()) #3, !dbg !264
  %64 = sub nsw i64 %56, %58, !dbg !296
  call void @llvm.dbg.value(metadata i64 %64, metadata !282, metadata !DIExpression()) #3, !dbg !264
  %65 = bitcast i8* %61 to i64*, !dbg !297
  %66 = load i64, i64* %65, align 8, !dbg !298, !tbaa !299
  %67 = add i64 %66, 1, !dbg !298
  store i64 %67, i64* %65, align 8, !dbg !298, !tbaa !299
  %68 = getelementptr inbounds i8, i8* %61, i64 8, !dbg !302
  %69 = bitcast i8* %68 to i64*, !dbg !302
  %70 = load i64, i64* %69, align 8, !dbg !303, !tbaa !304
  %71 = add i64 %64, %70, !dbg !303
  store i64 %71, i64* %69, align 8, !dbg !303, !tbaa !304
  br label %72

72:                                               ; preds = %49, %60, %63
  %73 = phi i32 [ %51, %63 ], [ 0, %49 ], [ 0, %60 ], !dbg !264
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %54), !dbg !305
  br label %74, !dbg !306

74:                                               ; preds = %19, %1, %72
  %75 = phi i32 [ %73, %72 ], [ -1, %1 ], [ -1, %19 ], !dbg !200
  ret i32 %75, !dbg !307
}
...
!3 = !DIFile(filename: "xdp_test_icmp_type.c", directory: "/home/aino/Projects/xapture/filter/filter-test")
!4 = !{!5, !14}
