; ModuleID = 'xdp_test_icmp_code.c'
source_filename = "xdp_test_icmp_code.c"
...
define dso_local i32 @xdp_parse_prog(%struct.xdp_md* nocapture readonly %0) #0 section "xdp_generated" !dbg !85 {
  ...
  br i1 %14, label %75, label %15, !dbg !217
...
15:                                               ; preds = %1
  ...
  br i1 %18, label %19, label %50, !dbg !224
...
19:                                               ; preds = %15
  ...
  br i1 %23, label %75, label %24, !dbg !229
...
27:                                               ; preds = %24
  ...
  br i1 %31, label %50, label %45, !dbg !240
...
32:                                               ; preds = %24
  ...
  br i1 %36, label %50, label %45, !dbg !247
...
37:                                               ; preds = %24
  ...
  br i1 %41, label %50, label %42, !dbg !254

42:                                               ; preds = %37
  call void @llvm.dbg.value(metadata i8* %20, metadata !170, metadata !DIExpression()), !dbg !200
  call void @llvm.dbg.value(metadata i8* %20, metadata !102, metadata !DIExpression(DW_OP_plus_uconst, 8, DW_OP_stack_value)), !dbg !200
  call void @llvm.dbg.value(metadata i8* %20, metadata !170, metadata !DIExpression()), !dbg !200
  call void @llvm.dbg.value(metadata i32 1, metadata !101, metadata !DIExpression()), !dbg !200
  call void @llvm.dbg.value(metadata i8* %20, metadata !170, metadata !DIExpression()), !dbg !200
  call void @llvm.dbg.value(metadata i8* %20, metadata !170, metadata !DIExpression()), !dbg !200
  %43 = getelementptr i8, i8* %7, i64 35, !dbg !255
...
50:                                               ; preds = %42, %49, %48, %47, %46, %37, %32, %27, %15, %45
  %51 = phi i32 [ 0, %15 ], [ 1, %42 ], [ 6, %45 ], [ 0, %27 ], [ 0, %32 ], [ 0, %37 ], [ 2, %46 ], [ 3, %47 ], [ 4, %48 ], [ 5, %49 ], !dbg !200
  %52 = phi i32 [ 2, %15 ], [ 2, %42 ], [ 2, %45 ], [ 0, %27 ], [ 0, %32 ], [ 0, %37 ], [ 2, %46 ], [ 2, %47 ], [ 2, %48 ], [ 2, %49 ], !dbg !200
  call void @llvm.dbg.value(metadata i32 %52, metadata !100, metadata !DIExpression()), !dbg !200
  call void @llvm.dbg.value(metadata i32 %51, metadata !101, metadata !DIExpression()), !dbg !200
  call void @llvm.dbg.label(metadata !199), !dbg !262
  %53 = getelementptr inbounds [14 x i8], [14 x i8]* %3, i64 0, i64 0, !dbg !261
  call void @llvm.lifetime.start.p0i8(i64 14, i8* nonnull %53) #3, !dbg !261
  call void @llvm.dbg.declare(metadata [14 x i8]* %3, metadata !194, metadata !DIExpression()), !dbg !261
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 1 dereferenceable(14) %53, i8* nonnull align 1 dereferenceable(14) getelementptr inbounds ([14 x i8], [14 x i8]* @__const.xdp_parse_prog.____fmt, i64 0, i64 0), i64 14, i1 false), !dbg !261
  %54 = call i32 (i8*, i32, ...) inttoptr (i64 6 to i32 (i8*, i32, ...)*)(i8* nonnull %53, i32 14, i32 %51) #3, !dbg !261
  call void @llvm.lifetime.end.p0i8(i64 14, i8* nonnull %53) #3, !dbg !263
  %55 = bitcast i32* %2 to i8*, !dbg !264
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %55), !dbg !264
  call void @llvm.dbg.value(metadata %struct.xdp_md* %0, metadata !269, metadata !DIExpression()) #3, !dbg !264
  call void @llvm.dbg.value(metadata i32 %52, metadata !270, metadata !DIExpression()) #3, !dbg !264
  call void @llvm.dbg.value(metadata i32 %51, metadata !271, metadata !DIExpression()) #3, !dbg !264
  store i32 %51, i32* %2, align 4, !tbaa !284
  %56 = load i32, i32* %8, align 4, !dbg !285, !tbaa !210
  %57 = zext i32 %56 to i64, !dbg !286
  call void @llvm.dbg.value(metadata i64 %57, metadata !272, metadata !DIExpression()) #3, !dbg !264
  %58 = load i32, i32* %4, align 4, !dbg !287, !tbaa !202
  %59 = zext i32 %58 to i64, !dbg !288
  call void @llvm.dbg.value(metadata i64 %59, metadata !273, metadata !DIExpression()) #3, !dbg !264
  %60 = icmp ugt i32 %51, 5, !dbg !289
  br i1 %60, label %73, label %61, !dbg !291

61:                                               ; preds = %50
  call void @llvm.dbg.value(metadata i32* %2, metadata !271, metadata !DIExpression(DW_OP_deref)) #3, !dbg !264
  %62 = call i8* inttoptr (i64 1 to i8* (i8*, i8*)*)(i8* bitcast (%struct.bpf_map_def* @xdp_stats_map to i8*), i8* nonnull %55) #3, !dbg !292
  call void @llvm.dbg.value(metadata i8* %62, metadata !274, metadata !DIExpression()) #3, !dbg !264
  %63 = icmp eq i8* %62, null, !dbg !293
  br i1 %63, label %73, label %64, !dbg !295

64:                                               ; preds = %61
  call void @llvm.dbg.value(metadata i8* %62, metadata !274, metadata !DIExpression()) #3, !dbg !264
  %65 = sub nsw i64 %57, %59, !dbg !296
  call void @llvm.dbg.value(metadata i64 %65, metadata !282, metadata !DIExpression()) #3, !dbg !264
  %66 = bitcast i8* %62 to i64*, !dbg !297
  %67 = load i64, i64* %66, align 8, !dbg !298, !tbaa !299
  %68 = add i64 %67, 1, !dbg !298
  store i64 %68, i64* %66, align 8, !dbg !298, !tbaa !299
  %69 = getelementptr inbounds i8, i8* %62, i64 8, !dbg !302
  %70 = bitcast i8* %69 to i64*, !dbg !302
  %71 = load i64, i64* %70, align 8, !dbg !303, !tbaa !304
  %72 = add i64 %65, %71, !dbg !303
  store i64 %72, i64* %70, align 8, !dbg !303, !tbaa !304
  br label %73

73:                                               ; preds = %50, %61, %64
  %74 = phi i32 [ %52, %64 ], [ 0, %50 ], [ 0, %61 ], !dbg !264
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %55), !dbg !305
  br label %75, !dbg !306

75:                                               ; preds = %19, %1, %73
  %76 = phi i32 [ %74, %73 ], [ -1, %1 ], [ -1, %19 ], !dbg !200
  ret i32 %76, !dbg !307
}
...
!3 = !DIFile(filename: "xdp_test_icmp_code.c", directory: "/home/aino/Projects/xapture/filter/filter-test")
!4 = !{!5, !14}
...
!255 = !DILocation(line: 117, column: 23, scope: !256)
!256 = distinct !DILexicalBlock(scope: !85, file: !3, line: 117, column: 6)
!257 = !{!258, !205, i64 1}
!258 = !{!"icmphdr", !205, i64 0, !205, i64 1, !222, i64 2, !205, i64 4}
